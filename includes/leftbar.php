...
<div class="bg-dark text-light border-right"  id="sidebar-wrapper">
      <div class="sidebar-heading bg-dark text-light"> Admin panel</div>
      <div class="list-group list-group-flush">
        <a href="quality-report.php" class="list-group-item list-group-item-action bg-dark text-light ">Quality Report</a>
        <a href="gnr.php" class="list-group-item list-group-item-action bg-dark text-light">GNR sheet</a>
